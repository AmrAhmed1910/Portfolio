...
const Hero = () => {
    return ( 
    <div className='border-b border-neutral-900 pb-24 lg:mb-35 lg:ml-20'>
        <div className="flex flex-wrap lg:flex-nowrap">
            <div className='w-full lg:w-1/2 flex justify-center lg:justify-start'>
            <div className="flex flex-col items-center lg:items-start mx-4 ">
                <h1 className='pb-6 text-5xl font-thin tracking-tight lg:mt-16 lg:text-6xl'>
                    Amr Ahmed
                    </h1>
            ...
            <div className='overflow-hidden relative lg-mr-10'>
                <img src={Profile} alt="Amr Ahmed" className="relative z-10 mx-auto rounded-xl lg:max-w-xs" />
            </div>
            </div>
        </div>
    </div> );
